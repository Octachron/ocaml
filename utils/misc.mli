...
module Style : sig
  ...
  val as_inline_code: ('a, 'i) Format_doc.printer -> ('a,'i) Format_doc.printer
  val inline_code: (string, 'i) Format_doc.printer
...
val print_see_manual : (int list,_) Format_doc.printer
(** See manual section *)
