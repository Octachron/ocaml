...
\newcommand{\lsection}{\@ifstar{\@lsectionstar}{\@lsection}}
\newcommand{\lsubsection}{\@ifstar{\@lsubsectionstar}{\@lsubsection}}
\newcommand{\lsubsubsection}{\@ifstar{\@lsubsubsectionstar}{\@lsubsubsection}}

\newcommand{\@lsection}[2]{\section{#2}\label{s:#1}}
\newcommand{\@lsubsection}[2]{\subsection{#2}\label{ss:#1}}
\newcommand{\@lsubsubsection}[2]{\subsubsection{#2}\label{sss:#1}}
\newcommand{\@lsectionstar}[2]{\section*{#2}\label{s:#1}}
\newcommand{\@lsubsectionstar}[2]{\subsection*{#2}\label{ss:#1}}
\newcommand{\@lsubsubsectionstar}[2]{\subsubsection*{#2}\label{sss:#1}}

\newcommand{\lparagraph}[1]{\paragraph{#1}\label{p:#1}}
