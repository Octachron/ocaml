...
and simplify_partial_application env r ~lhs_of_application
  ...
  | Always_inline | Never_inline ->
    Location.prerr_warning (Debuginfo.to_location dbg)
      (Warnings.Inlining_impossible (I18n.s "[@inlined] attributes may not be used \
        on partial applications"))
  | Unroll _ ->
    Location.prerr_warning (Debuginfo.to_location dbg)
      (Warnings.Inlining_impossible (I18n.s "[@unroll] attributes may not be used \
        on partial applications"))
  | Default_inline -> ()
  end;
  ...
  | Always_specialise | Never_specialise ->
    Location.prerr_warning (Debuginfo.to_location dbg)
      (Warnings.Inlining_impossible
         (I18n.s "[@specialised] attributes may not be used \
             on partial applications"))
  | Default_specialise -> ()
  end;
