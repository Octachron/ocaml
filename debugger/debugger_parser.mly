...
longident :
    LIDENT                      { Lident $1 }
  | module_path DOT LIDENT      { Ldot(Location.mknoloc $1,Location.mknoloc $3)}
  | OPERATOR                    { Lident $1 }
  | module_path DOT OPERATOR    { Ldot(Location.mknoloc $1,Location.mknoloc $3)}
  | module_path DOT LPAREN OPERATOR RPAREN { Ldot(Location.mknoloc $1,
                                                  Location.mknoloc $4) }
;

module_path :
    UIDENT                      { Lident $1 }
  | module_path DOT UIDENT      { Ldot(Location.mknoloc $1,Location.mknoloc $3)}
;
...
opt_longident :
  ...
  | module_path DOT UIDENT      { Some (Ldot(Location.mknoloc $1,
                                             Location.mknoloc $3)) }
  |                             { None };
