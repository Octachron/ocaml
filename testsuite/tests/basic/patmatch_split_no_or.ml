...
(let
  (last_is_anys/0 =
     (function param/0 : int
       (catch
         (if (field_imm 0 param/0) (if (field_imm 1 param/0) (exit 5) 1)
           (if (field_imm 1 param/0) (exit 5) 2))
        with (5) 3)))
  (apply (field_mut 1 (global Toploop!)) "last_is_anys" last_is_anys/0))
val last_is_anys : bool * bool -> int = <fun>
|}, Rectypes{|
(let
  (last_is_anys/0 =
     (function param/0 : int
       (catch
         (if (field_imm 0 param/0) (if (field_imm 1 param/0) (exit 8) 1)
           (if (field_imm 1 param/0) (exit 8) 2))
        with (8) 3)))
  (apply (field_mut 1 (global Toploop!)) "last_is_anys" last_is_anys/0))
val last_is_anys : bool * bool -> int = <fun>
|}]
...
(let
  (last_is_vars/0 =
     (function param/1 : int
       (catch
         (if (field_imm 0 param/1) (if (field_imm 1 param/1) (exit 11) 1)
           (if (field_imm 1 param/1) (exit 11) 2))
        with (11) 3)))
...
(let
  (last_is_vars/0 =
     (function param/1 : int
       (catch
         (if (field_imm 0 param/1) (if (field_imm 1 param/1) (exit 14) 1)
           (if (field_imm 1 param/1) (exit 14) 2))
        with (14) 3)))
  (apply (field_mut 1 (global Toploop!)) "last_is_vars" last_is_vars/0))
val last_is_vars : bool * bool -> int = <fun>
|}, Rectypes{|
(let
  (last_is_vars/0 =
     (function param/1 : int
       (catch
         (if (field_imm 0 param/1) (if (field_imm 1 param/1) (exit 17) 1)
           (if (field_imm 1 param/1) (exit 17) 2))
        with (17) 3)))
  (apply (field_mut 1 (global Toploop!)) "last_is_vars" last_is_vars/0))
val last_is_vars : bool * bool -> int = <fun>
|}]
   ...
   f/0 =
     (function param/2 : int
       (let (*match*/0 =a (field_imm 0 param/2))
         (catch
           (if (== *match*/0 A/0) (if (field_imm 1 param/2) 1 (exit 23))
             (exit 23))
          with (23)
  ...
  (C/0 = (apply (field_mut 0 (global Toploop!)) "C/28")
   ...
   f/0 =
     (function param/2 : int
       (let (*match*/0 =a (field_imm 0 param/2))
         (catch
           (if (== *match*/0 A/0) (if (field_imm 1 param/2) 1 (exit 28))
             (exit 28))
          with (28)
           (if (field_imm 1 param/2)
             (if (== (field_imm 0 *match*/0) B/0) 2
  ...
  (C/0 = (apply (field_mut 0 (global Toploop!)) "C/28")
   ...
   f/0 =
     (function param/2 : int
       (let (*match*/0 =a (field_imm 0 param/2))
         (catch
           (if (== *match*/0 A/0) (if (field_imm 1 param/2) 1 (exit 33))
             (exit 33))
          with (33)
           (if (field_imm 1 param/2)
             (if (== (field_imm 0 *match*/0) B/0) 2
