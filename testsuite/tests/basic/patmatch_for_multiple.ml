...
(let (*match*/0 = 3 *match*/1 = 2 *match*/2 = 1)
  (catch
    (catch
      (catch (if (!= *match*/1 3) (exit 8) (exit 6)) with (8)
        (if (!= *match*/0 1) (exit 7) (exit 6)))
     with (7) 0)
   with (6) 1))
(let (*match*/0 = 3 *match*/1 = 2 *match*/2 = 1)
  (catch (if (!= *match*/1 3) (if (!= *match*/0 1) 0 (exit 6)) (exit 6))
   with (6) 1))
- : bool = false
|}, Rectypes{|
(let (*match*/0 = 3 *match*/1 = 2 *match*/2 = 1)
  (catch
    (catch
      (catch (if (!= *match*/1 3) (exit 12) (exit 10)) with (12)
        (if (!= *match*/0 1) (exit 11) (exit 10)))
     with (11) 0)
   with (10) 1))
(let (*match*/0 = 3 *match*/1 = 2 *match*/2 = 1)
  (catch (if (!= *match*/1 3) (if (!= *match*/0 1) 0 (exit 10)) (exit 10))
   with (10) 1))
- : bool = false
|}];;
...
(let (*match*/3 = 3 *match*/4 = 2 *match*/5 = 1)
  (catch
    (if (!= *match*/4 3)
      (if (!= *match*/3 1) 0
        (exit 14 (makeblock 0 *match*/3 *match*/4 *match*/5)))
      (exit 14 (makeblock 0 *match*/3 *match*/4 *match*/5)))
   with (14 x/2) (seq (ignore x/2) 1)))
- : bool = false
|}, Principal{|
(let (*match*/3 = 3 *match*/4 = 2 *match*/5 = 1)
  (catch
    (catch
      (catch
        (if (!= *match*/4 3) (exit 20)
          (let (x/0 =a (makeblock 0 *match*/3 *match*/4 *match*/5))
            (exit 18 x/0)))
       with (20)
        (if (!= *match*/3 1) (exit 19)
          (let (x/1 =a (makeblock 0 *match*/3 *match*/4 *match*/5))
            (exit 18 x/1))))
     with (19) 0)
   with (18 x/2) (seq (ignore x/2) 1)))
(let (*match*/3 = 3 *match*/4 = 2 *match*/5 = 1)
  (catch
    (if (!= *match*/4 3)
      (if (!= *match*/3 1) 0
        (exit 18 (makeblock 0 *match*/3 *match*/4 *match*/5)))
      (exit 18 (makeblock 0 *match*/3 *match*/4 *match*/5)))
   with (18 x/2) (seq (ignore x/2) 1)))
- : bool = false
|}, Rectypes{|
(let (*match*/3 = 3 *match*/4 = 2 *match*/5 = 1)
  (catch
    (catch
      (catch
        (if (!= *match*/4 3) (exit 24)
          (let (x/0 =a (makeblock 0 *match*/3 *match*/4 *match*/5))
            (exit 22 x/0)))
       with (24)
        (if (!= *match*/3 1) (exit 23)
          (let (x/1 =a (makeblock 0 *match*/3 *match*/4 *match*/5))
            (exit 22 x/1))))
     with (23) 0)
   with (22 x/2) (seq (ignore x/2) 1)))
(let (*match*/3 = 3 *match*/4 = 2 *match*/5 = 1)
  (catch
    (if (!= *match*/4 3)
      (if (!= *match*/3 1) 0
        (exit 22 (makeblock 0 *match*/3 *match*/4 *match*/5)))
      (exit 22 (makeblock 0 *match*/3 *match*/4 *match*/5)))
   with (22 x/2) (seq (ignore x/2) 1)))
- : bool = false
|}];;
...
(function a/6[int] b/6[int]
  (catch
    (if a/6
      (let (x/7 =a[int] a/6 p/6 =a (makeblock 0 a/6 b/6)) (exit 89 x/7 p/6))
      (let (x/8 =a b/6 p/7 =a (makeblock 0 a/6 b/6)) (exit 89 x/8 p/7)))
   with (89 x/9[int] p/8) (makeblock 0 (int,*) x/9 p/8)))
(function a/6[int] b/6[int]
  (catch
    (if a/6 (exit 89 a/6 (makeblock 0 a/6 b/6))
      (exit 89 b/6 (makeblock 0 a/6 b/6)))
   with (89 x/9[int] p/8) (makeblock 0 (int,*) x/9 p/8)))
- : bool -> bool -> bool * (bool * bool) = <fun>
|}, Principal{|
(function a/6[int] b/6[int]
  (catch
    (if a/6
      (let (x/7 =a[int] a/6 p/6 =a (makeblock 0 a/6 b/6)) (exit 93 x/7 p/6))
      (let (x/8 =a b/6 p/7 =a (makeblock 0 a/6 b/6)) (exit 93 x/8 p/7)))
   with (93 x/9[int] p/8) (makeblock 0 (int,*) x/9 p/8)))
(function a/6[int] b/6[int]
  (catch
    (if a/6 (exit 93 a/6 (makeblock 0 a/6 b/6))
      (exit 93 b/6 (makeblock 0 a/6 b/6)))
   with (93 x/9[int] p/8) (makeblock 0 (int,*) x/9 p/8)))
- : bool -> bool -> bool * (bool * bool) = <fun>
|}, Rectypes{|
(function a/6[int] b/6[int]
  (catch
    (if a/6
      (let (x/7 =a[int] a/6 p/6 =a (makeblock 0 a/6 b/6)) (exit 97 x/7 p/6))
      (let (x/8 =a b/6 p/7 =a (makeblock 0 a/6 b/6)) (exit 97 x/8 p/7)))
   with (97 x/9[int] p/8) (makeblock 0 (int,*) x/9 p/8)))
(function a/6[int] b/6[int]
  (catch
    (if a/6 (exit 97 a/6 (makeblock 0 a/6 b/6))
      (exit 97 b/6 (makeblock 0 a/6 b/6)))
   with (97 x/9[int] p/8) (makeblock 0 (int,*) x/9 p/8)))
- : bool -> bool -> bool * (bool * bool) = <fun>
|}]
...
(function a/9[int] b/9
  (catch
    (if a/9 (if b/9 (let (p/11 =a (field_imm 0 b/9)) p/11) (exit 122))
      (exit 122))
   with (122) (let (p/12 =a (makeblock 0 a/9 b/9)) p/12)))
(function a/9[int] b/9
  (catch (if a/9 (if b/9 (field_imm 0 b/9) (exit 122)) (exit 122)) with (122)
    (makeblock 0 a/9 b/9)))
- : bool -> bool tuplist -> bool * bool tuplist = <fun>
|}, Principal{|
(function a/9[int] b/9
  (catch
    (if a/9 (if b/9 (let (p/11 =a (field_imm 0 b/9)) p/11) (exit 126))
      (exit 126))
   with (126) (let (p/12 =a (makeblock 0 a/9 b/9)) p/12)))
(function a/9[int] b/9
  (catch (if a/9 (if b/9 (field_imm 0 b/9) (exit 126)) (exit 126)) with (126)
    (makeblock 0 a/9 b/9)))
- : bool -> bool tuplist -> bool * bool tuplist = <fun>
|}, Rectypes{|
(function a/9[int] b/9
  (catch
    (if a/9 (if b/9 (let (p/11 =a (field_imm 0 b/9)) p/11) (exit 130))
      (exit 130))
   with (130) (let (p/12 =a (makeblock 0 a/9 b/9)) p/12)))
(function a/9[int] b/9
  (catch (if a/9 (if b/9 (field_imm 0 b/9) (exit 130)) (exit 130)) with (130)
    (makeblock 0 a/9 b/9)))
- : bool -> bool tuplist -> bool * bool tuplist = <fun>
|}]
...
(function a/10[int] b/10
  (catch
    (catch
      (if a/10
        (if b/10 (let (p/13 =a (field_imm 0 b/10)) (exit 134 p/13))
          (exit 135))
        (exit 135))
     with (135) (let (p/14 =a (makeblock 0 a/10 b/10)) (exit 134 p/14)))
   with (134 p/15) p/15))
(function a/10[int] b/10
  (catch
    (catch
      (if a/10 (if b/10 (exit 134 (field_imm 0 b/10)) (exit 135)) (exit 135))
     with (135) (exit 134 (makeblock 0 a/10 b/10)))
   with (134 p/15) p/15))
- : bool -> bool tuplist -> bool * bool tuplist = <fun>
|}, Principal{|
(function a/10[int] b/10
  (catch
    (catch
      (if a/10
        (if b/10 (let (p/13 =a (field_imm 0 b/10)) (exit 139 p/13))
          (exit 140))
        (exit 140))
     with (140) (let (p/14 =a (makeblock 0 a/10 b/10)) (exit 139 p/14)))
   with (139 p/15) p/15))
(function a/10[int] b/10
  (catch
    (catch
      (if a/10 (if b/10 (exit 139 (field_imm 0 b/10)) (exit 140)) (exit 140))
     with (140) (exit 139 (makeblock 0 a/10 b/10)))
   with (139 p/15) p/15))
- : bool -> bool tuplist -> bool * bool tuplist = <fun>
|}, Rectypes{|
(function a/10[int] b/10
  (catch
    (catch
      (if a/10
        (if b/10 (let (p/13 =a (field_imm 0 b/10)) (exit 144 p/13))
          (exit 145))
        (exit 145))
     with (145) (let (p/14 =a (makeblock 0 a/10 b/10)) (exit 144 p/14)))
   with (144 p/15) p/15))
(function a/10[int] b/10
  (catch
    (catch
      (if a/10 (if b/10 (exit 144 (field_imm 0 b/10)) (exit 145)) (exit 145))
     with (145) (exit 144 (makeblock 0 a/10 b/10)))
   with (144 p/15) p/15))
- : bool -> bool tuplist -> bool * bool tuplist = <fun>
|}]
