...
Error: Signature mismatch:
       ...
       Try changing value "f" to be a "t/2 -> unit"
...
Error: Signature mismatch:
       ...
       Try changing value "f" to be a "(module s/2) -> t/2 -> t/2"
...
Error: Signature mismatch:
       ...
       Try changing value "f" to be a "a/2 -> (module a) -> a/2"
...
Error: Signature mismatch:
       ...
       Try changing value "f" to be a "t -> t -> t -> t"
