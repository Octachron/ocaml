           ...
           (switch* *match*/3
            ...
            case int 1:
             (let
               ...
               (if (isint *match*/5) (if *match*/5 12 (exit 7)) (exit 7)))))
        with (7)
                  ...
                  (let (tag/1 =a (caml_obj_tag *match*/2))
                    (if (== tag/1 250) (field_mut 0 *match*/2)
                      (if (|| (== tag/1 246) (== tag/1 244))
                        ...
                        *match*/2)))
                *match*/5 =o (field_mut 0 (field_imm 1 param/1)))
               (if (isint *match*/5) (if *match*/5 12 (exit 9)) (exit 9)))))
        with (9)
         (raise (makeblock 0 (global Match_failure/0!) [0: "" 1 49])))))
  (apply (field_mut 1 (global Toploop!)) "lazy_needs_partial"
    lazy_needs_partial/0))
                  ...
                  (let (tag/1 =a (caml_obj_tag *match*/2))
                    (if (== tag/1 250) (field_mut 0 *match*/2)
                      (if (|| (== tag/1 246) (== tag/1 244))
                        ...
                        *match*/2)))
                *match*/5 =o (field_mut 0 (field_imm 1 param/1)))
               (if (isint *match*/5) (if *match*/5 12 (exit 11)) (exit 11)))))
        with (11)
         (raise (makeblock 0 (global Match_failure/0!) [0: "" 1 49])))))
  (apply (field_mut 1 (global Toploop!)) "lazy_needs_partial"
    lazy_needs_partial/0))
  ...
  (guard_needs_partial/0 =
     (function param/3 : int
       (let (*match*/7 =o (field_mut 0 param/3))
         (catch (if (isint *match*/7) (if *match*/7 (exit 21) 0) (exit 21))
          with (21)
           (if (opaque 0) 1
             (if (isint *match*/7) 12
...
(let
  (guard_needs_partial/0 =
     (function param/3 : int
       (let (*match*/7 =o (field_mut 0 param/3))
         (catch (if (isint *match*/7) (if *match*/7 (exit 24) 0) (exit 24))
          with (24)
           (if (opaque 0) 1
             (if (isint *match*/7) 12
               (raise (makeblock 0 (global Match_failure/0!) [0: "" 1 46]))))))))
...
(let
  (guard_needs_partial/0 =
     (function param/3 : int
       (let (*match*/7 =o (field_mut 0 param/3))
         (catch (if (isint *match*/7) (if *match*/7 (exit 27) 0) (exit 27))
          with (27)
           (if (opaque 0) 1
             (if (isint *match*/7) 12
               (raise (makeblock 0 (global Match_failure/0!) [0: "" 1 46]))))))))
