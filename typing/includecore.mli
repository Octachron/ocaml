...
val report_value_mismatch :
  string -> string ->
  Env.t ->
  (value_mismatch, 'impl) Format_doc.Compat.printer

val report_type_mismatch :
  string -> string -> string ->
  Env.t ->
  (type_mismatch, 'impl) Format_doc.Compat.printer

val report_extension_constructor_mismatch :
  string -> string -> string ->
  Env.t ->
  (extension_constructor_mismatch, 'impl) Format_doc.Compat.printer
