...
val polyfy:
  ...
  type_expr * (unit, (Errortrace.polyfy_error * type_expr) list) result
...
val expanded_diff :
  ...
  Errortrace.expanded_type Errortrace.diff
...
val moregeneral: Env.t -> inst_nongen:bool -> type_expr -> type_expr -> unit
        (* Check if the first type scheme is more general than the second. *)
val is_moregeneral: Env.t -> inst_nongen:bool -> type_expr -> type_expr -> bool
