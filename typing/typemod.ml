  ...
  if !Clflags.print_types then begin
    Printtyp.wrap_printing_env initial_env
      (fun () -> fprintf std_formatter "%a@." Printtyp.print_signature @@
        List.map Outcometree.Decorate.sig_item @@ Printtyp.signature simple_sg);
...
let report_error ppf = function
    Cannot_apply mty ->
      fprintf ppf
        ...
        print_modtype (Outcometree.Decorate.module_type @@ modtype mty)
  | Not_included errs ->
      fprintf ppf
  ...
  | Non_generalizable typ ->
      fprintf ppf
        ...
        print_type (Outcometree.Decorate.typ @@ type_scheme typ)
  | Non_generalizable_class (id, desc) ->
      fprintf ppf
        "@[The type of this class,@ %a,@ \
           contains type variables that cannot be generalized@]"
        print_sigitem
        (Outcometree.Decorate.sig_item @@ class_declaration id desc)
