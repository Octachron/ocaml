...
let report_lookup_error _loc env ppf = function
  | Unbound_value(lid, hint) -> begin
      fprintf ppf "Unbound value %a" !print_longident.printer lid;
  ...
  | Unbound_type lid ->
      fprintf ppf "Unbound type constructor %a" !print_longident.printer lid;
      spellcheck ppf extract_types env lid;
  | Unbound_module lid -> begin
      fprintf ppf "Unbound module %a" !print_longident.printer lid;
      ...
      | _ ->
         fprintf ppf
           ...
           !print_longident.printer lid
           "but module types are not modules"
    end
  | Unbound_constructor lid ->
      fprintf ppf "Unbound constructor %a" !print_longident.printer lid;
      spellcheck ppf extract_constructors env lid;
  | Unbound_label lid ->
      fprintf ppf "Unbound record field %a" !print_longident.printer lid;
      spellcheck ppf extract_labels env lid;
  | Unbound_class lid -> begin
      fprintf ppf "Unbound class %a" !print_longident.printer lid;
  ...
  | Unbound_modtype lid -> begin
      fprintf ppf "Unbound module type %a" !print_longident.printer lid;
  ...
  | Unbound_cltype lid ->
      fprintf ppf "Unbound class type %a" !print_longident.printer lid;
  ...
  | Functor_used_as_structure lid ->
      fprintf ppf "@[The module %a is a functor, \
                   it cannot have any components@]" !print_longident.printer lid
  ...
  | Generative_used_as_applicative lid ->
      fprintf ppf "@[The functor %a is generative,@ it@ cannot@ be@ \
                   applied@ in@ type@ expressions@]" !print_longident.printer lid
  | Cannot_scrape_alias(lid, p) ->
      ...
      fprintf ppf
        ...
        !print_longident.printer lid !print_path.printer p cause
