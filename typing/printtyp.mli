...
val longident:  (Longident.t, 'impl) printer
val ident: (Ident.t, 'impl) printer
val namespaced_ident: Shape.Sig_component_kind.t -> Ident.t -> string

val tree_of_path: Path.t -> out_ident
val path: (Path.t, 'impl) printer
val string_of_path: Path.t -> string

val type_path: (Path.t, 'impl) printer
...
(** [list_explanations()] return the list of conflict explanations
  ...
  val print_located_explanations: (explanation list, 'impl) printer

  val print_explanations: 'impl formatter -> unit
...
(** Print out a type.  This will pick names for type variables, and will not
    ...
    [prepared_type_expr].  *)
val type_expr: (type_expr, 'impl) printer
...
val prepared_type_expr: (type_expr, 'impl) printer
...
val constructor_arguments: (constructor_arguments, 'impl) printer
val tree_of_type_scheme: type_expr -> out_type

val type_scheme: (type_expr, 'impl) printer
val prepared_type_scheme: (type_expr, 'impl) printer
val shared_type_scheme: (type_expr, 'impl) printer
...
val value_description: Ident.t -> (value_description, 'impl) printer
val label : (label_declaration, 'impl) printer
val add_constructor_to_preparation : constructor_declaration -> unit
val prepared_constructor : (constructor_declaration, 'impl) printer
val constructor : (constructor_declaration, 'impl) printer
val tree_of_type_declaration:
  Ident.t -> type_declaration -> rec_status -> out_sig_item
val add_type_declaration_to_preparation :
  Ident.t -> type_declaration -> unit
val prepared_type_declaration: Ident.t -> (type_declaration, 'impl) printer
val type_declaration: Ident.t -> (type_declaration, 'impl) printer
...
val prepared_extension_constructor:
    Ident.t -> (extension_constructor, 'impl) printer
...
val modtype: (module_type, 'impl) printer
val signature: (signature, 'impl) printer
...
val modtype_declaration: Ident.t -> (modtype_declaration, 'impl) printer
val class_type: (class_type, 'impl) printer
val tree_of_class_declaration:
    Ident.t -> class_declaration -> rec_status -> out_sig_item
val class_declaration: Ident.t -> (class_declaration, 'impl) printer
val tree_of_cltype_declaration:
    Ident.t -> class_type_declaration -> rec_status -> out_sig_item
val cltype_declaration: Ident.t -> (class_type_declaration, 'impl) printer
val type_expansion :
  type_or_scheme -> (Errortrace.expanded_type, 'impl) printer
val prepare_expansion: Errortrace.expanded_type -> Errortrace.expanded_type


module Compat: sig
  (** Compatibility printer for the *)
...
val report_ambiguous_type_error:
    'impl formatter -> Env.t -> (Path.t * Path.t) -> (Path.t * Path.t) list ->
