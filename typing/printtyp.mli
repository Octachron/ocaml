...
val context: Env.t -> printing_context

val longident: formatter -> Longident.t -> unit
val ident: printing_context -> formatter -> Ident.t -> unit
val tree_of_path: Path.t -> out_ident
val path: formatter -> Path.t -> unit
val string_of_path: Path.t -> string

val type_path: printing_context -> formatter -> Path.t -> unit
...
val strings_of_paths: printing_context -> namespace -> Path.t list -> string list
...
module Conflicts: sig
  val exists: printing_context -> bool
  ...
  val list_explanations: printing_context -> explanation list
(** [list_explanations()] return the list of conflict explanations
  ...
  val print_explanations: Format.formatter -> printing_context -> unit
  (** Print all conflict explanations collected up to this point *)

  val reset: printing_context -> unit
end
end
...
(** Print out a type.  This will pick names for type variables, and will not
    ...
    [prepared_type_expr].  *)
val type_expr: printing_context -> formatter -> type_expr -> unit
...
val prepare_for_printing: printing_context -> type_expr list -> unit
val prepared_type_expr: printing_context -> formatter -> type_expr -> unit
...
val constructor_arguments: printing_context -> formatter -> constructor_arguments -> unit
val tree_of_type_scheme: printing_context -> type_expr -> out_type
val type_scheme: printing_context -> formatter -> type_expr -> unit
val shared_type_scheme: printing_context -> formatter -> type_expr -> unit
...
val tree_of_value_description: printing_context -> Ident.t -> value_description -> out_sig_item
val value_description: printing_context -> Ident.t -> formatter -> value_description -> unit
val label : printing_context -> formatter -> label_declaration -> unit
val constructor : printing_context -> formatter -> constructor_declaration -> unit
val tree_of_type_declaration:
    printing_context -> Ident.t -> type_declaration -> rec_status -> out_sig_item
val type_declaration: printing_context -> Ident.t -> formatter -> type_declaration -> unit
val tree_of_extension_constructor:
    printing_context -> Ident.t -> extension_constructor -> ext_status -> out_sig_item
val extension_constructor:
    printing_context -> Ident.t -> formatter -> extension_constructor -> unit
...
val tree_of_module:
    printing_context -> Ident.t -> ?ellipsis:bool -> module_type -> rec_status -> out_sig_item
val modtype: printing_context -> formatter -> module_type -> unit
val signature: printing_context -> formatter -> signature -> unit
val tree_of_modtype: printing_context -> module_type -> out_module_type
val tree_of_modtype_declaration:
    printing_context -> Ident.t -> modtype_declaration -> out_sig_item
...
val functor_parameters:
  ...
  (printing_context -> 'b -> Format.formatter -> unit) ->
  (Ident.t option * 'b) list -> Format.formatter -> unit

type type_or_scheme = Type | Type_scheme

val tree_of_signature: printing_context -> Types.signature -> out_sig_item list
val tree_of_typexp: printing_context -> type_or_scheme -> type_expr -> out_type
val modtype_declaration: printing_context -> Ident.t -> formatter -> modtype_declaration -> unit
val class_type: printing_context -> formatter -> class_type -> unit
val tree_of_class_declaration:
    printing_context -> Ident.t -> class_declaration -> rec_status -> out_sig_item
val class_declaration: printing_context -> Ident.t -> formatter -> class_declaration -> unit
val tree_of_cltype_declaration:
    printing_context -> Ident.t -> class_type_declaration -> rec_status -> out_sig_item
val cltype_declaration: printing_context -> Ident.t -> formatter -> class_type_declaration -> unit
val type_expansion :
  printing_context -> type_or_scheme -> Format.formatter -> Errortrace.expanded_type -> unit
val prepare_expansion: printing_context -> Errortrace.expanded_type -> Errortrace.expanded_type
...
val print_items: (Env.t -> signature_item -> 'a option) ->
  printing_context -> signature_item list -> (out_sig_item * 'a option) list
...
val printed_signature: printing_context -> string -> formatter -> signature -> unit
