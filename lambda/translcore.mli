...
val transl_args: scopes:scopes -> (arg_label * apply_arg) list ->
  (arg_label * (Lambda.lambda, unit) Typedtree.arg_or_omitted) list
val transl_apply: scopes:scopes
                  -> ?tailcall:tailcall_attribute
                  -> ?inlined:inline_attribute
                  -> ?specialised:specialise_attribute
                  -> lambda -> (arg_label * (Lambda.lambda, unit) Typedtree.arg_or_omitted) list
